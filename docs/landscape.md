...
| **Medicaid 1115 waivers + evaluations** | Eligibility/benefit terms, evaluation findings | High (Medicaid) | Long PDFs on Medicaid.gov; trackers summarize status, not row-level terms/outcomes |
